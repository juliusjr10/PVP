...
import { GiBroccoli } from 'react-icons/gi'; // Import GiBroccoli icon
import { differenceInDays } from 'date-fns';

export default function FoodCard({ onClick }) {
            ...
            <CardActionArea onClick={onClick} sx={{ cursor: 'pointer', height: 200 }}>
                <CardContent sx={{ textAlign: 'center' }}>
                    <div style={{ backgroundColor: '#f3e7ff', padding: '8px', borderRadius: '50%', width: 'fit-content', margin: 'auto' }}>
                        <GiBroccoli style={{ fontSize: '6rem', margin: 'auto', color: '#5a00ec' }} /> {/* Adjust fontSize here */}
                    </div>
